...
class __TwigTemplate_92e0695551080287fd0a767ce475018468deb2661318080f40a14fede5e5b26d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
#}
{% if items %}
  <nav class=\"navigation mt-5 d-print-none\" role=\"navigation\" aria-labelledby=\"{{ heading_id }}\">
    ...
    <ul class=\"pager__items js-pager__items pagination justify-content-center\">
      ...
      {% for key, item in items.pages %}
        <li class=\" p-0 page-item pager__item{{ current == key ? ' active' : '' }}\">
          {% if current == key %}
...
{% endif %}
", "themes/contrib/bfd/templates/navigation/pager.html.twig", "/Users/marcelino.martinez/sandbox/publicbarlive/publicbar/web/themes/contrib/bfd/templates/navigation/pager.html.twig");
    }
